...
const known = {
  ...
  gangwon: ["ONBOARDING_READY", "https://m.gangwon.to/gwtour/now/festival", "official_tourism_listing", "generic_fallback_paginated_probe", "강원관광 축제·행사 목록이 현재 행사 후보의 title·full-year start/end·venue와 durable detail/list URL을 함께 제공하고 pagination/bounded listing 구조를 가짐"],
  ...
  chungnam: ["ONBOARDING_READY", "https://tour.chungnam.go.kr/prog/fstvl/kor/sub02_02_02/list.do", "official_tourism_listing", "generic_fallback_paginated_probe", "충남관광 축제 목록이 pagination과 함께 title·full-year 행사기간·장소를 제공하고 detail URL이 durable함"],
  ...
  jeonnam: ["WATCH", "https://www.jeonnam.go.kr", "official_government_homepage", "source_core_missing", "전라남도 공식 홈페이지는 확인했으나 현재 행사·축제의 full-year date·venue를 함께 제공하는 지속적 canonical listing을 확인하지 못함. 단발성 공지/보도자료는 사용하지 않음"],
  ...
  jeju: ["ONBOARDING_READY", "https://www.visitjeju.net/kr/festival", "official_tourism_listing", "generic_fallback_paginated_probe", "Visit Jeju 축제 목록/상세가 현재 후보의 title·full-year start/end·venue와 durable first-party URL을 제공하고 pagination/bounded listing 구조를 가짐"],
