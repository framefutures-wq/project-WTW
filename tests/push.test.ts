...
test("notification payload remains factual and uses an internal deterministic click target", () => {
  ...
  assert.deepEqual(cancelled, { type: "CANCELLED_OR_POSTPONED", title: "갈틈", body: "행사 취소 안내가 확인됐어요", event_id: "행사/한글", url: "/?event=%ED%96%89%EC%82%AC%2F%ED%95%9C%EA%B8%80", tag: "wtw:status:e:cancelled" });
