...
test("Korean Folk official promotion parser keeps numeric identity and complete official dates", () => {
  ...
  assert.deepEqual(parseKoreanFolkDetail('"id",53,"title","귀신사바 귀신놀이","description","startsAt","26.09.01","endsAt","26.11.15"'), { title: "귀신사바 귀신놀이", description: null, startDate: "2026-09-01", endDate: "2026-11-15" });
