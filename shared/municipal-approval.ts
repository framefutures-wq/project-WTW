...
export const approvalCandidates = (candidates: ApprovalCandidate[]) => candidates.filter((candidate) => candidate.selection_gate === "MAIN" && candidate.duplicate_status === "NEW" && candidate.ready_for_review);
